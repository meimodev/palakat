...
- [ ] 1. Update Backend Prisma Schema
  - [ ] 1.1 Add Reminder enum to schema.prisma
    - Add enum with values: TEN_MINUTES, THIRTY_MINUTES, ONE_HOUR, TWO_HOURS
    - _Requirements: 1.3_
  - [ ] 1.2 Add reminder field to Activity model
  ...
  - [ ] 1.3 Run Prisma migration
    ...
    - _Requirements: 1.1_
  - [ ] 1.4 Update seed.ts to include reminder data
...
- [ ] 2. Create Backend DTOs and Update Service
  - [ ] 2.1 Create CreateActivityDto with validation
    - Create DTO class with class-validator decorators
    - Include @IsEnum(Reminder) @IsOptional() for reminder field
    - _Requirements: 1.3, 1.4_
  - [ ] 2.2 Create UpdateActivityDto
    - Extend CreateActivityDto with PartialType
    - _Requirements: 3.1, 3.2, 3.3_
  - [ ] 2.3 Update ActivityService.create to handle reminder
    - Include reminder field in activity creation
    - _Requirements: 1.1, 1.2_
  - [ ] 2.4 Update ActivityService.update to handle reminder
    - Include reminder field in activity update
    - _Requirements: 3.1, 3.2_
  - [ ] 2.5 Update ActivityController to use DTOs
...
- [ ] 4. Update Shared Package Models
  - [ ] 4.1 Update Reminder enum with JSON serialization
    - Add @JsonEnum annotation with valueField
    - Add value field mapping to backend enum values
    - _Requirements: 4.1, 4.2_
  - [ ] 4.2 Add reminder field to CreateActivityRequest
  ...
  - [ ] 4.4 Update Activity model to include reminder field
    - Add optional Reminder? reminder field to Activity model
    - Regenerate freezed/json_serializable code
...
- [ ] 5. Checkpoint - Ensure shared package changes work
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 6. Update Mobile App Controller
  - [ ] 6.1 Update ActivityPublishController.submit to include reminder
...
- [ ] 7. Backend Integration Tests
  - [ ]* 7.1 Write property test for reminder persistence on create
    - **Property 1: Reminder persistence on create**
    - **Validates: Requirements 1.1, 2.1**
  - [ ]* 7.2 Write property test for announcement activities
    - **Property 3: Announcement activities accept null reminder**
    - **Validates: Requirements 1.2**
  - [ ]* 7.3 Write property test for reminder in list responses
    - **Property 4: Reminder included in list responses**
    - **Validates: Requirements 2.2, 2.3**
  - [ ]* 7.4 Write property test for reminder update persistence
