...
String _package = "Transcutaneous electrical nerve stimulation (TENS) therapy";
String _service = "Service B";

class BookPhysiotherapySummaryScreen extends ConsumerWidget {
  const BookPhysiotherapySummaryScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ScaffoldWidget(
      ...
      child: BookSummaryWidget(
        ...
        // },
        onPressedConfirm: () {
          context.pushNamed(AppRoute.bookPhysiotherapyGeneralConsent);
        },
      ),
    );
  }
