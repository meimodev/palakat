...
String _package = "Blood Sugar 2 Hours After Eating";
String _service = "Blood";

class BookLaboratorySummaryScreen extends ConsumerWidget {
  const BookLaboratorySummaryScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ScaffoldWidget(
      ...
      child: BookSummaryWidget(
        ...
        // },
        onPressedConfirm: () {
          context.pushNamed(AppRoute.bookLaboratoryPreScreening);
        },
      ),
    );
  }
