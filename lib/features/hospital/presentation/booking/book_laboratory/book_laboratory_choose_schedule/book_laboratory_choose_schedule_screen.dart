...
class BookLaboratoryChooseScheduleScreen extends ConsumerWidget {
  const BookLaboratoryChooseScheduleScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller =
        ref.watch(bookLaboratoryChooseScheduleControllerProvider.notifier);
    final state = ref.watch(bookLaboratoryChooseScheduleControllerProvider);
    ...
    return ScaffoldWidget(
      ...
      child: BookChooseScheduleWidget(
        ...
        onSelectedSchedule: (DateTimeRange schedule) {
          context.pushNamed(AppRoute.bookLaboratorySummary);
        },
      ),
    );
  }
