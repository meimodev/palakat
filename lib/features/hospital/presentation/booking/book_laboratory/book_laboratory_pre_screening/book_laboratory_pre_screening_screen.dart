...
class BookLaboratoryPreScreening extends ConsumerWidget {
  const BookLaboratoryPreScreening({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(bookLaboratoryPreScreeningProvider);
    final controller = ref.watch(bookLaboratoryPreScreeningProvider.notifier);
