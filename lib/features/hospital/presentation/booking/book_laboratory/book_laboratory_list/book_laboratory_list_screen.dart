...
List<BookServiceModel> _serviceList = [
  BookServiceModel(
    category: "Blood",
    name: "Blood Sugar 2 Hours After Eating",
    locations: "RSH Kemayoran, RSH Podomoro, 1+",
    price: "Rp 260.000",
  ),
  BookServiceModel(
      category: "Cholesterol",
      name: "Complete Hematology - (CBC + DIFF + LED)",
  ...
  BookServiceModel(
    category: "Blood",
    name: "Marker of Acute Infection (CRP-High Sensitive)",
    locations: "RSH Kemayoran, RSH Podomoro, 1+",
    price: "Rp 560.000",
...
class BookLaboratoryListScreen extends ConsumerWidget {
  const BookLaboratoryListScreen({
    super.key,
  });
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ScaffoldWidget(
      ...
      child: BookListScreenWidget(
        ...
        onTapListItem: () {
          context.pushNamed(AppRoute.bookLaboratoryDetail);
        },
      ),
    );
  }
