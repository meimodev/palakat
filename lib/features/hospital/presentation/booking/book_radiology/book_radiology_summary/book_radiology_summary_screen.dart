...
String _package = "dr. Leon Gerald SpPD";
String _service = "Internal Medicine - Internist";

class BookRadiologySummaryScreen extends ConsumerWidget {
  const BookRadiologySummaryScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ScaffoldWidget(
      ...
      child: BookSummaryWidget(
        ...
        // },
        onPressedConfirm: () {
          context.pushNamed(AppRoute.bookRadiologyPreScreening);
        },
      ),
    );
  }
