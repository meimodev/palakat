...
class BookRadiologyChooseScheduleScreen extends ConsumerWidget {
  const BookRadiologyChooseScheduleScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller =
        ref.watch(bookRadiologyChooseScheduleControllerProvider.notifier);
    final state = ref.watch(bookRadiologyChooseScheduleControllerProvider);
    ...
    return ScaffoldWidget(
      ...
      child: BookChooseScheduleWidget(
        ...
        onSelectedSchedule: (DateTimeRange schedule) {
          context.pushNamed(AppRoute.bookRadiologySummary);
        },
      ),
    );
  }
