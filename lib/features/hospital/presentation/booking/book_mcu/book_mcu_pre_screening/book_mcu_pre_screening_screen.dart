...
class BookMcuPreScreening extends ConsumerWidget {
  const BookMcuPreScreening({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(bookMcuPreScreeningProvider);
    final controller = ref.watch(bookMcuPreScreeningProvider.notifier);
