...
class BookVaccinePreScreening extends ConsumerWidget {
  const BookVaccinePreScreening({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(bookVaccinePreScreeningProvider);
    final controller = ref.watch(bookVaccinePreScreeningProvider.notifier);
    ...
    return ScaffoldWidget(
      ...
      child: BookPreScreeningScreenWidget(
        ...
        onTapSubmit: () => context.pushNamed(AppRoute.bookVaccinePaymentMethod),
      ),
    );
  }
}
