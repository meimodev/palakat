...
String _doctor = "dr. Leon Gerald, SpPD";
String _schedule = "Thu, 16 Mar 2023 | 13:30 - 14:00";
String _package = "Influenza 4 Strain Vaccine";
String _service = "Influenza";

class BookVaccineSummaryScreen extends ConsumerWidget {
  const BookVaccineSummaryScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ScaffoldWidget(
      ...
      child: BookSummaryWidget(
        ...
        // },
        onPressedConfirm: () {
          context.pushNamed(AppRoute.bookVaccinePreScreening);
        },
      ),
    );
  }
