...
class BookPregnancyChooseScheduleScreen extends ConsumerWidget {
  const BookPregnancyChooseScheduleScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller =
        ref.watch(bookPregnancyChooseScheduleControllerProvider.notifier);
    final state = ref.watch(bookPregnancyChooseScheduleControllerProvider);
    ...
    return ScaffoldWidget(
      ...
      child: BookChooseScheduleWidget(
        ...
        onSelectedSchedule: (DateTimeRange schedule) {
          context.pushNamed(AppRoute.bookPregnancySummary);
        },
      ),
    );
  }
