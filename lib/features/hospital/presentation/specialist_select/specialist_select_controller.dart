...
class SpecialistSelectController extends StateNotifier<SpecialistSelectState> {
  SpecialistSelectController(this.hospitalService)
      : super(SpecialistSelectState());
  ...
  Future<void> _loadData(int pageKey) async {
    final result = await hospitalService.selectSpecialists(
      PaginationRequest(
        page: pageKey,
...
final specialistSelectControllerProvider = StateNotifierProvider.autoDispose<
    SpecialistSelectController, SpecialistSelectState>(
  (ref) {
    return SpecialistSelectController(ref.read(hospitalServiceProvider));
  },
);
