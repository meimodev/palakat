...
const String _admissionId = "IPA02070008";
const String _roomNumber = "857-01";
...
class PatientPortalInpatientScreen extends ConsumerWidget {
  const PatientPortalInpatientScreen({super.key});
