...
class SelfCheckInPhysiotherapyVirtualQueueScreen extends ConsumerWidget {
  const SelfCheckInPhysiotherapyVirtualQueueScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(
      selfCheckInPhysiotherapyVirtualQueueController(_journeyList).notifier,
    );
    final state = ref.watch(
      selfCheckInPhysiotherapyVirtualQueueController(_journeyList),
    );
          ...
          child: Column(
            children: [
              FeaturingAppointmentWidget(
                variety: LocaleKeys.text_physiotherapy.tr(),
                date: "16 Mar 2023  13:30",
                doctorName: "dr. Leon Gerald, SpPD",
                hospital: "RSH Kemayoran",
                journey: LocaleKeys.text_physiotherapy.tr(),
              ...
              PatientJourneyLayoutWidget(
                ...
                image: Assets.icons.tint.massage,
                title: "${LocaleKeys.text_physiotherapyTime.tr()}!",
                subtitle:
                    LocaleKeys.text_nowItsYourTimeToEnterPhysiotherapyRoom.tr(),
                queueNumber: '016',
