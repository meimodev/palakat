...
class BottomNavBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final double iconSize = BaseSize.w22;
    ...
    final List<Color> selectedPalette = <Color>[
      ...
      BaseColor.blue.shade500,          // Explore - Blue
      BaseColor.yellow.shade600,        // Songs - Yellow/Orange
      BaseColor.red.shade500,           // Ops - Red
    ...
    final List<Color> unselectedPalette = <Color>[
      selectedPalette[0].withValues(alpha: 0.6),
      selectedPalette[1].withValues(alpha: 0.6),
      selectedPalette[2].withValues(alpha: 0.6),
      selectedPalette[3].withValues(alpha: 0.6),
      selectedPalette[4].withValues(alpha: 0.6),
    ];
    // Keep unselected label neutral for readability
    final Color unselectedColor = BaseColor.secondaryText.withValues(alpha: 0.7);
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(
          top: BorderSide(
            color: BaseColor.secondaryText.withValues(alpha: 0.12),
            width: 0.5,
          ),
        ),
      ),
      child: NavigationBarTheme(
        data: NavigationBarThemeData(
          ...
          // Keep icon colors handled via our svg color filters.
        ),
        child: NavigationBar(
          ...
          indicatorColor: selectedColor.withValues(alpha: 0.24),
