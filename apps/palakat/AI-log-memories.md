- Title: Routing convention
  ...
  Tags: [routing]
  Content: When passing Freezed models between screens using go_router, pass models via RouteParam.extra as JSON and reconstruct with fromJson in the route.

- Title: Navigation preference
  ID: 464f3cfd-2faf-434d-927e-6ae4e48e2691
  Tags: [navigation]
  Content: Prefer go_router for all navigation.

- Title: Freezed for models and state
  ID: d2167092-45d6-4291-9910-f42f2c4851cc
  Tags: [models, state, freezed]
  Content: Use Freezed for new model/state classes; convert simple classes where applicable.

- Title: Consistent label and variable updates
  ID: a828667a-4a43-4a94-9f65-7811aab18fec
  Tags: [naming, ui]
  Content: Update variable names and strings when UI labels change.

- Title: Riverpod codegen migration for AccountRepository
  ID: 279f4e5b-172d-424d-bc56-c913738e23a7
  Tags: [riverpod, codegen]
  Content: AccountRepository migrated to Riverpod codegen; build_runner OK; deps present.

- Title: Color opacity preference
  ID: 158cc4e3-968e-4cc1-977c-aff2bee55c6a
  Tags: [ui, colors]
  Content: Prefer withValues over withOpacity for alpha adjustments.
...
- Title: AI prompt execution logging to AI-log.md
  ...
  Content: Append entry to AI-log.md after each prompt with model, time, and summary.
...
- Title: Log memory state to AI-log-memories.md after each prompt
  ...
  Content: Maintain AI-log-memories.md with timestamped memory snapshots.
...
- Title: Routing convention
  ID: 257c177a-1df3-40ec-9452-0406d8205b29
  Tags: [routing]
  Content: When passing Freezed models between screens using go_router, pass via RouteParam.extra as JSON and reconstruct with fromJson.

- Title: Navigation preference
  ID: 464f3cfd-2faf-434d-927e-6ae4e48e2691
  Tags: [navigation]
  Content: Use go_router instead of Navigator.

- Title: Freezed for models and state
  ID: d2167092-45d6-4291-9910-f42f2c4851cc
  Tags: [models, state, freezed]
  Content: Use Freezed for new model/state classes.

- Title: Consistent label and variable updates
  ID: a828667a-4a43-4a94-9f65-7811aab18fec
  Tags: [naming, ui]
  Content: Keep labels and variable names in sync.

- Title: Riverpod codegen migration for AccountRepository
  ID: 279f4e5b-172d-424d-bc56-c913738e23a7
  Tags: [riverpod, codegen]
  Content: AccountRepository migrated to Riverpod codegen.

- Title: Color opacity preference
  ID: 158cc4e3-968e-4cc1-977c-aff2bee55c6a
  Tags: [ui, colors]
  Content: Prefer withValues for opacity.

- Title: AI prompt execution logging to AI-log.md
  ID: 36727eab-e6d0-4ab9-b19c-34bdd0133644
  Tags: [preferences, ai_logging, workflow]
  Content: Log each prompt in AI-log.md.

- Title: Log memory state to AI-log-memories.md after each prompt
  ID: 26b93947-a721-47cf-a534-672d20df57a4
  Tags: [preferences, ai_logging, memories]
  Content: Update AI-log-memories.md with timestamped snapshot.
# AI Memories Log
...
- Title: Routing convention
  ID: 257c177a-1df3-40ec-9452-0406d8205b29
  Tags: [routing]
  Content: Ensured dashboard announcement navigation passes full Activity via RouteParamKey.activity with toJson(), matching route expectations.
