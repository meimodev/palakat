...
class ArticlesReveal extends StatefulWidget {
  ...
  @override
  State<ArticlesReveal> createState() => _ArticlesRevealState();
}

class _ArticlesRevealState extends State<ArticlesReveal> {
  Timer? _timer;
  var _visible = false;
...
class ArticlesAnimatedPresence extends StatelessWidget {
  const ArticlesAnimatedPresence({
    super.key,
