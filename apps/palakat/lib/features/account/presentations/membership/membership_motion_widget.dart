...
class MembershipReveal extends StatefulWidget {
  ...
  @override
  State<MembershipReveal> createState() => _MembershipRevealState();
}

class _MembershipRevealState extends State<MembershipReveal> {
  Timer? _timer;
  var _visible = false;
...
class MembershipAnimatedPresence extends StatelessWidget {
  const MembershipAnimatedPresence({
    super.key,
