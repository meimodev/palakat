...
class _AccountScreenState extends ConsumerState<AccountScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ScaffoldWidget(
      loading: state.loading || state.isRegistering || state.isFetchingAccount,
                ...
                children: [
                  ...
                  Opacity(
                    opacity: (state.isPhoneVerified || state.account != null)
                        ...
                        : 1.0,
                    child: IgnorePointer(
                      ignoring: state.isPhoneVerified || state.account != null,
                      child: InputWidget.text(
                        key: ValueKey('phone_${state.phone}'),
                        hint: "0812-3456-7890",
                        label: (state.isPhoneVerified || state.account != null)
                  ...
                  InputWidget.text(
                    ...
                    hint: "Email Address",
                    label: "optional email for notifications and communication",
                ...
                if (context.mounted) {
                  ...
                  if (updatedAccount.membership?.id != null) {
                    ...
                    context.pushNamed(
                      AppRoute.membership,
                      extra: RouteParam(
                        params: {'membershipId': updatedAccount.membership!.id},
                      ),
                    );
                  } else {
